...
整体要求：
1. 风险识别需基于公司的具体业务模式、行业地位、财务状况和宏观环境
2. 每一项风险需先给出【风险描述】，再给出【影响分析】和【应对措施】
3. 风险应围绕"战略风险、运营风险、财务风险、政策风险、市场风险"等维度展开
4. 语言风格专业客观，避免绝对化表述，使用"可能""有望""或将"等措辞

结构要求：
一、战略与竞争力风险
【风险描述】分析公司核心产品/技术面临的迭代风险、技术替代风险，或竞争地位可能的削弱
【影响分析】阐述该风险对公司市场份额、定价权、盈利能力的长期影响
【应对措施】讨论公司的技术创新投入、产品迭代规划、竞争优势维持的可能途径
二、财务与运营风险
【风险描述】分析公司面临的汇率波动、原材料成本波动、应收账款、现金流等风险
【影响分析】估算相关风险对净利润、现金流、资产质量的影响幅度
【应对措施】讨论对冲工具、成本管理、流动性管理等风险管理手段
三、业务转型与盈利能力风险
【风险描述】关注新业务/新方向的盈利不及预期、传统业务衰退等风险
【影响分析】评估相关业务调整对整体盈利能力、增长动力的影响
【应对措施】分析公司的转型进展、业务组合调整、盈利能力改善的可能性

输出要求：
- 按优先级从高到低排列风险
- 每项风险需自洽完整，逻辑清晰
- 影响分析应尽可能量化（如对利润、现金流、增速的具体影响）
- 总结部分需综合评估整体风险水位，明确最核心的风险制约因素
- 不引用未披露的预测数据，仅基于已知事实和合理推断
"""

# 5. 个股研报结构生成 System Prompt
...
6. **标题**: 6. 风险提示 (内容要求：{risk_instruction} 针对目标：{query})
